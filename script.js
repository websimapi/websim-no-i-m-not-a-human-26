...
import { preprocessSprite } from './sprite_preprocess.js';
document.addEventListener('DOMContentLoaded', () => {
    ...
    let fogInstance, processedSpriteUrl = null;
    let cutsceneAudio;
    ...
    function animateBirds() {
        ...
        const spriteUrl = processedSpriteUrl || 'bird_flap_sprite.png';
        if (!flockContainer) return;
        ...
        for (let i = 0; i < flockSize; i++) {
            ...
            bird.className = 'bird';
            bird.style.backgroundImage = `url(${spriteUrl})`;
